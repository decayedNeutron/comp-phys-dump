...
OPEN (unit = 11, file = 'IsingMore8ABS.dat', status = 'new')
...
en = en*0.5d0
print*, "For Random Initial state of 8 x 8 x 8 lattice"
...
!     mn = 0
    ...
    kT = 4.7d0 - T*0.02d0
    print*,T, 'Temperature :',kT

    DO time = 1, ni
!
!     WRITE(filen, '(A8,I1)') 'A7/GRID8', 0
!     WRITE(fn2, '(A9,I1)') 'A7/GRID28', 0
