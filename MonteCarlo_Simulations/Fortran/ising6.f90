...
OPEN (unit = 11, file = 'Is_ran_8ff.dat', status = 'new')
...
en = en*0.5d0
! print*, "For Random Initial state of 9x9x9 lattice @ kT = 3.9 ->"
...
!     mn = 0
    ...
    WRITE(filen, '(A8,I1)') 'R7/GRID8', 0
    WRITE(fn2, '(A9,I1)') 'R7/GRID28', 0
 ...
 !       WRITE(11,*) time,en/real(1000), mn/real(1000)
    ...
    print*, "Final State, <E/spin>:", e_av/(real(n)),"<M/spin>:",m_av/real(n)
    print*,''

    write(11,*) kT,m_av/real(n),e_av/(real(n)),cv,chi,bincu
